...
#define CLGREEN		"\033[0;32m"
#define CLBOLDGREEN	"\033[1;32m"
#define CLBOLDRED	"\033[1;31m"
#define CLBOLDBLUE	"\033[1;34m"
#define CLBOLDYELLOW	"\033[1;33m"
#define CLYELLOW	"\033[0;33m"
#define CLMAGENTA	"\033[0;35m"     /* фиолетовый цвет знаков*/
#define CLCYAN		"\033[0;36m"     /* цвет морской волны знаков*/
#define CLDEFAULT	"\033[0m"
#define CLBOLDWHITE	"\033[1;37m"
#define CLBOLDNORMAL	"\033[22m"
#define CLDEFAULTTEXT CLBOLDWHITE
...
typedef struct{
	const char* name;
	const void (*f_exec)(int argc, const char* const* argv);
...
//void setListComs(microrl_t* const pThis, exec_cmds_t*** ap_cmds);
