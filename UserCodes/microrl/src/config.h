...
#ifdef CLI_PROMPT_DEFAULT_TEXT
#define _PROMPT_DEFAULT_TEXT CLI_PROMPT_DEFAULT_TEXT
#endif
#ifndef CLI_PROMPT_DEFAULT_TEXT
#define	_PROMPT_DEFAULT_TEXT "MCU CLI >: " /*use size for positions under him*/
#endif
#define _PROMPT_DEFAULT CLBOLDBLUE _PROMPT_DEFAULT_TEXT CLDEFAULTTEXT	/* grehelpen color*/
...
#define _PROMPT_LEN       (sizeof(_PROMPT_DEFAULT_TEXT)-1)
